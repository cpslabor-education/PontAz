# 05 Automatic and Intelligent Robots course
#
# webots controller: 
# 
# Our robot in the simulation has 2 drive motor, named: leftMotor, rightMotor; they has one varible called: leftMotorVelocity, rightMotorVelocity.
# The HEAD unit has a rotation motor and a proximity sensor; the motor's varible called: headVelocity, the sensor variable called: headUltrasonicSensor.
# The HEAD unit's motor's has a rotation sensor, the variable called: headRotationSensor.
# The rear bumper has a touch sensor, the variable called: touchSensor.
#
# This node not calculate anything, just read the msg and send the varibales to the motors, sensors.
# 
# The topics send from this node:
#   get_left_motor_velocity:    Float64
#   get_right_motor_velocity:   Float64
#   get_head_motor_velocity:    Float64
#   get_head_ultrasonic_sensor: Float64
#   get_head_rotation_sensor:   Float64
#   get_touch_sensor:           Bool
#
# The topics read from remote node:
#   set_left_motor_velocity:    Float64
#   set_right_motor_velocity:   Float64
#   set_head_motor_velocity:    Float64
#   
# Created by: Füleki Tamás 2021.10.27
...
class Robot(Node):
    ...
    def __init__(self):
        ...
        self.pub_left_motor_velocity  = self.create_publisher(Float64, 'get_left_motor_velocity',     10)
        self.pub_right_motor_velocity = self.create_publisher(Float64, 'get_right_motor_velocity',    10)
